...
<body>
  ...
  <!-- 부트 스트랩 -->
	...
	<!-- 모든 컴파일된 플러그인을 포함하니다 (아래), 원하지 않는다면 필요한 각각의 파일을 포함하세요. -->
 ...
 <!-- <a class="left carousel-control"style="font-size:30px;font-weight:bold;" href="#carouselExampleIndicators" data-slide="prev" onclick="$('#myCarousel').carousel('prev')">
	  <span class="slide_arrow">&lt;</span>
	  </a>
	  <a class="right carousel-control"style="font-size:30px;font-weight:bold" href="#carouselExampleIndicators" data-slide="next" onclick="$('#myCarousel').carousel('next')">
	  <span class="slide_arrow">&gt;</span> 
	  </a> -->
